...
function scroll(){
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('a[href^="#"]').click(function(){
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').animate({scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0___default()(target).offset().top}, 800);
        return false;
    });

    let button = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll');
